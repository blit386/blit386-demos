...
blit386-demos/
  ...
  scripts/                     # Repo maintenance scripts (run via package scripts)
    ...
    check-demo-registry.mjs    # pnpm run check:demo-registry – DEMO_ORDER / vintage / disk consistency
...
pnpm run check:demo-registry    # DEMO_ORDER / VINTAGE_URLS / src/*.js consistency
...
| Skill                                 | Purpose                                                                    |
| ------------------------------------- | -------------------------------------------------------------------------- |
| `demos-preflight`                     | Run format, lint, spellcheck, knip, docs:links, check:demo-registry, build |
